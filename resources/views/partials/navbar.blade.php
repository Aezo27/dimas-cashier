<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link {{ $title != 'Laporan Barang Keluar' ? 'collapsed' : '' }} {{ $title != 'Laporan Barang Masuk' ? 'collapsed' : '' }}" data-bs-target="#transaksi" data-bs-toggle="collapse" href="">
        <i class="bi bi-layout-text-window-reverse"></i><span>Laporan</span>
      </a>
      <ul id="transaksi" class="nav-content collapse show" data-bs-parent="#sidebar-nav" style="">
        <li>
          <a href="{{ route('lap_masuk') }}" class="{{ $title == 'Laporan Barang Masuk' ? 'active' : '' }}">
            <i class="bi bi-circle"></i><span>Barang Masuk</span>
          </a>
        </li>
        <li>
          <a href="{{ route('lap_keluar') }}" class="{{ $title == 'Laporan Barang Keluar' ? 'active' : '' }}">
