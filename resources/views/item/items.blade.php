                ...
                <table class="table datatable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $item['harga'] }}</td>
                      <td><img src="storage/{{ $item->gambar }}" width="100"></td>
                      ...
                      <td><a href="/items/{{ $item['slug'] }}"><button type="button" class="btn btn-success">Ubah</button></a>
                          <a href="/items/hapus/{{ $item['id'] }}"><button type="button" class="btn btn-danger"onClick="return confirm('Yakin dihapus?')">Hapus</button></td>
                          </tr>
                      @endforeach
                  </tbody>
                </table>
