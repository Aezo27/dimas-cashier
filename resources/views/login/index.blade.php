...
<head>
  ...
  <title>Login - UD. Dewa-Dewi</title>
                  ...
                  <form class="row g-3 needs-validation" action="/login" method="POST" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" id="email" autofocus required>
                        @error('email')
